        ...
        >
            <div className="container mx-auto px-6 ">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
                    ...
                    <div className="space-y-11 text-xl">
                        <div className="flex items-start">
                            <div className="text-purple text-3xl mr-4">
                                <FaMapMarkerAlt />
                            </div>
                            <div className="">
                        ...
                        <div className="pt-4">
                            <h3 className='text-3xl font-semibold mb-7'>Follow Me</h3>
                            <div className="flex space-x-4 ">
                                <a href="" className='w-15 h-15 rounded-full bg-dark-300 flex items-center justify-center text-black
                                 hover:bg-black hover:text-white transition duration-300 '>
                                    <FaGithub />
                                 </a>
                                <a href="" className='w-15 h-15 rounded-full bg-dark-300 flex items-center justify-center text-blue
                                ...
                                <a href="" className='w-15 h-15 rounded-full bg-dark-300 flex items-center justify-center text-green-400
